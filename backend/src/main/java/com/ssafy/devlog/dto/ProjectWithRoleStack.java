...
public class ProjectWithRoleStack {
	...
	public List<ProjectStack> getStacks() {
		return stacks;
	}
	public void setStacks(List<ProjectStack> stacks) {
		this.stacks = stacks;
	}
	public ProjectWithRoleStack(){
	}
	public ProjectWithRoleStack(Project p,List<ProjectRole> roles,List<ProjectStack> stacks){
		this.seq = p.getSeq();
	...
	public ProjectWithRoleStack(int seq, int seq_blog, String title, String regtime, int disclosure, int like_count,
			String img_url, String summary, String start_date, String finish_date, String github_url, String etc_url,
			String rep_url, String content, List<ProjectRole> roles, List<ProjectStack> stacks) {
		super();
		this.seq = seq;
		this.seq_blog = seq_blog;
		this.title = title;
