...
public class BlogTagController {
	...
	@GetMapping("{blog_seq}")
	public ResponseEntity<BlogTag> selectBlogTagByUser(@PathVariable int blog_seq) throws Exception {
	...
	@PostMapping
	public ResponseEntity<String> insertBlog(@RequestBody BlogTag blogTag) throws Exception {
