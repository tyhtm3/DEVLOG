...
public interface PostMapper {
	...
	public int selectPostCntByBlog(@Param("seq_user")int seq_user, @Param("disclosure")int disclosure,@Param("tag") List<String> tag);
	public List<Post> selectPostByBlog(@Param("seq_user") int seq_user,@Param("disclosure")int disclosure, @Param("offset") int offset, @Param("limit") int limit, @Param("tag") List<String> tag);
