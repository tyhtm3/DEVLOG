  ...
  <transition name="el-zoom-in-top">
    <div class="content-wrapper" style="background: white;">
      ...
      <div class="main-block">
        <hr>
        <div style="margin-bottom:15px; font-size:20px; text-align:center">
          <img src="http://i3a402.p.ssafy.io/images/summary.jpg" height="64" width="64"><br>
          SUMMARY
        </div>
          ...
          <div style="font-size:20px; text-align:center">
            <img src="http://i3a402.p.ssafy.io/images/tech.png" height="64" width="64"><br>
            TechStack
          </div>
          <div class="row">
              <div class="col-md-12">
          ...
          <hr>
          <div style="margin-bottom:15px; font-size:20px; text-align:center">
            <img src="http://i3a402.p.ssafy.io/images/project.png" height="64" width="64"><br>
            Project
          </div>
              ...
              <div id="timeline" style="margin-left: 25%;">
                ...
                <section>
                  <ul>
                    ...
                    <li><a :href="`http://i3a402.p.ssafy.io/blog/project/`+project.seq"><b>프로젝트 더보기</b></a></li>
                  </ul>
                </section>
              </section>
            </div>
